...
export function TariffChart({ data, height = 400 }: TariffChartProps) {
  return (
        ...
        <AreaChart data={data}>
          <defs>
            <linearGradient id="colorBaseline" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="95%" stopColor="#1fc7b6" stopOpacity={0}/>
            </linearGradient>
            <linearGradient id="colorActual" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#6f47c7" stopOpacity={0.35}/>
              <stop offset="95%" stopColor="#6f47c7" stopOpacity={0}/>
            </linearGradient>
          </defs>
